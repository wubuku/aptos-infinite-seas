module infinite_seas::roster_put_in_ship_inventory_logic {
    use std::vector;
    ...
    public(friend) fun verify(
        ...
        roster::new_roster_ship_inventory_put_in(
            id,
            roster,
            player_obj,
            ship_id,
    ...
    public(friend) fun mutate(
        ...
        let player_obj = roster::roster_ship_inventory_put_in_player_id(roster_ship_inventory_put_in);
