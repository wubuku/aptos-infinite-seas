module infinite_seas_common::ts_random_util {
    ...
    public fun get_int(seed: vector<u8>, bound: u64): u64 {
        (get_u256(seed) % (bound as u256) as u64)
    }

    public fun get_8_u32_vector(seed: vector<u8>): vector<u32> {
        let u_o = get_u256(seed);
    ...
    public fun get_4_u64(seed: vector<u8>): (u64, u64, u64, u64) {
        let u_o = get_u256(seed);
    ...
    public fun get_u256(seed: vector<u8>): u256 {
        let now = timestamp::now_microseconds();//clock::timestamp_ms(clock);
    ...
    public fun divide_int(seed: vector<u8>, value: u64, n: u64): vector<u64> {
