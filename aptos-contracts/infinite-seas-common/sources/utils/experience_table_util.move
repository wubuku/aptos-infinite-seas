module infinite_seas_common::experience_table_util {
    ...
    public fun calculate_new_level(
        ...
        experience_table_levels: &vector<ExperienceLevel>, //experience_table: &ExperienceTable,
        ...
        let xp_levels_len = vector::length(experience_table_levels);
        ...
        if (max_level > (player_level as u64)) {
            ...
            while (i <= max_level) {
                let xp_level = vector::borrow(experience_table_levels, i);
