...
module infinite_seas_map::map_location {
    ...
    public fun occupied_by(map_location: &MapLocation): Option<address> {
        map_location.occupied_by
    }

    public(friend) fun set_occupied_by(map_location: &mut MapLocation, occupied_by: Option<address>) {
