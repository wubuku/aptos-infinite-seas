...
public class HibernateShipBattleStateQueryRepository implements ShipBattleStateQueryRepository {
    ...
    public ShipBattleState get(String id) {
        ...
        ShipBattleState state = (ShipBattleState)getCurrentSession().get(AbstractShipBattleState.SimpleShipBattleState.class, id);
    ...
    public Iterable<ShipBattleState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ShipBattleState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ShipBattleState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ShipBattleState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public ShipBattleState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<ShipBattleState> list = (List<ShipBattleState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ShipBattleState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
