...
public class HibernateItemCreationStateQueryRepository implements ItemCreationStateQueryRepository {
    ...
    public ItemCreationState get(SkillTypeItemIdPair id) {
        ...
        ItemCreationState state = (ItemCreationState)getCurrentSession().get(AbstractItemCreationState.SimpleItemCreationState.class, id);
    ...
    public Iterable<ItemCreationState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ItemCreationState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<ItemCreationState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(ItemCreationState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public ItemCreationState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<ItemCreationState> list = (List<ItemCreationState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public ItemCreationState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
