...
package org.dddml.aptosinfiniteseas.domain.skillprocess.hibernate;
...
public class HibernateSkillProcessStateQueryRepository implements SkillProcessStateQueryRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("Id", "SkillProcessId", "ItemId", "StartedAt", "CreationTime", "Completed", "EndedAt", "ProductionMaterials", "BatchSize", "Version", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted"));
    ...
    public Iterable<SkillProcessState> getAll(Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(SkillProcessState.class);
    ...
    @Transactional(readOnly = true)
    public Iterable<SkillProcessState> get(org.dddml.support.criterion.Criterion filter, List<String> orders, Integer firstResult, Integer maxResults) {
        Criteria criteria = getCurrentSession().createCriteria(SkillProcessState.class);
        criteria.setResultTransformer(Criteria.DISTINCT_ROOT_ENTITY);
        HibernateUtils.criteriaAddFilterAndOrdersAndSetFirstResultAndMaxResults(criteria, filter, orders, firstResult, maxResults);
        addNotDeletedRestriction(criteria);
    ...
    @Transactional(readOnly = true)
    public SkillProcessState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders) {
        List<SkillProcessState> list = (List<SkillProcessState>)get(filter, orders, 0, 1);
    ...
    @Transactional(readOnly = true)
    public SkillProcessState getFirst(Map.Entry<String, Object> keyValue, List<String> orders) {
