...
public class HibernateSkillProcessStateRepository implements SkillProcessStateRepository {
    ...
    public SkillProcessState get(String id, boolean nullAllowed) {
    ...
    public void merge(SkillProcessState detached) {
        SkillProcessState persistent = getCurrentSession().get(AbstractSkillProcessState.SimpleSkillProcessState.class, detached.getId());
        if (persistent != null) {
