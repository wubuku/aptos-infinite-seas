...
package org.dddml.aptosinfiniteseas.domain.map.hibernate;
...
public class HibernateMapStateQueryRepository implements MapStateQueryRepository {
    ...
    private static final Set<String> readOnlyPropertyPascalCaseNames = new HashSet<String>(Arrays.asList("AccountAddress", "Locations", "OffChainVersion", "CreatedBy", "CreatedAt", "UpdatedBy", "UpdatedAt", "Active", "Deleted", "Version"));
    ...
    @Transactional(readOnly = true)
    public MapLocationState getMapLocation(String mapAccountAddress, Coordinates coordinates) {
        MapLocationId entityId = new MapLocationId(mapAccountAddress, coordinates);
        return (MapLocationState) getCurrentSession().get(AbstractMapLocationState.SimpleMapLocationState.class, entityId);
    }

    @Transactional(readOnly = true)
    public Iterable<MapLocationState> getMapLocations(String mapAccountAddress, org.dddml.support.criterion.Criterion filter, List<String> orders) {
        ...
        org.hibernate.criterion.Junction partIdCondition = org.hibernate.criterion.Restrictions.conjunction()
            .add(org.hibernate.criterion.Restrictions.eq("mapLocationId.mapAccountAddress", mapAccountAddress))
            ;
