...
import org.dddml.aptosinfiniteseas.specialization.NullReadOnlyProxyGenerator;
...
//    }
    ...
    public LocalSessionFactoryBean hibernateSessionFactory() throws IOException {
        ...
        sessionFactory.setPackagesToScan("org.dddml.aptosinfiniteseas.*"); //add annotation mappings
