...
import org.dddml.aptosinfiniteseas.domain.map.MapEvent.*;
...
//    public static MapState mutate(MapState mapState, BigInteger aptosEventVersion, BigInteger aptosEventSequenceNumber, String aptosEventType, AptosEventGuid aptosEventGuid, String eventStatus, MutationContext<MapState, MapState.MutableMapState> mutationContext) {
//    }
//}
    ...
    public void when(AbstractMapEvent.IslandAdded e) {
        ...
        MapState updatedMapState = (MapState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, coordinates, resources, aptosEventVersion, aptosEventSequenceNumber, aptosEventType, aptosEventGuid, eventStatus, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.dddml.aptosinfiniteseas.domain.map;
//
//public class AddIslandLogic {
//    public static MapState mutate(MapState mapState, Coordinates coordinates, ItemIdQuantityPairs resources, BigInteger aptosEventVersion, BigInteger aptosEventSequenceNumber, String aptosEventType, AptosEventGuid aptosEventGuid, String eventStatus, MutationContext<MapState, MapState.MutableMapState> mutationContext) {
//    }
//}
    ...
    public void when(AbstractMapEvent.MapIslandClaimed e) {
        ...
        MapState updatedMapState = (MapState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, coordinates, claimedBy, claimedAt, aptosEventVersion, aptosEventSequenceNumber, aptosEventType, aptosEventGuid, eventStatus, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.dddml.aptosinfiniteseas.domain.map;
//
//public class ClaimIslandLogic {
//    public static MapState mutate(MapState mapState, Coordinates coordinates, String claimedBy, BigInteger claimedAt, BigInteger aptosEventVersion, BigInteger aptosEventSequenceNumber, String aptosEventType, AptosEventGuid aptosEventGuid, String eventStatus, MutationContext<MapState, MapState.MutableMapState> mutationContext) {
//    }
//}
    ...
    class SimpleMapLocationStateCollection implements EntityStateCollection.ModifiableEntityStateCollection<Coordinates, MapLocationState>, Collection<MapLocationState> {
        ...
        public MapLocationState getOrAddDefault(Coordinates coordinates) {
            ...
            if (s == null) {
                MapLocationId globalId = new MapLocationId(getAccountAddress(), coordinates);
