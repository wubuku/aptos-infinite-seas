...
public abstract class AbstractMapApplicationService implements MapApplicationService {
    ...
    public MapLocationState getMapLocation(String mapAccountAddress, Coordinates coordinates) {
        return getStateQueryRepository().getMapLocation(mapAccountAddress, coordinates);
    }

    public Iterable<MapLocationState> getMapLocations(String mapAccountAddress, Criterion filter, List<String> orders) {
        return getStateQueryRepository().getMapLocations(mapAccountAddress, filter, orders);
    }
