...
public abstract class AbstractRosterAggregate extends AbstractAggregate implements RosterAggregate {
    ...
    public static class SimpleRosterAggregate extends AbstractRosterAggregate {
        ...
        @Override
        public void create(RosterId rosterId, Integer status, Long speed, Coordinates updatedCoordinates, BigInteger coordinatesUpdatedAt, Coordinates targetCoordinates, Coordinates originCoordinates, String shipBattleId, Long offChainVersion, String commandId, String requesterId, RosterCommands.Create c) {
            java.util.function.Supplier<RosterEvent.RosterCreated> eventFactory = () -> newRosterCreated(rosterId, status, speed, updatedCoordinates, coordinatesUpdatedAt, targetCoordinates, originCoordinates, shipBattleId, offChainVersion, commandId, requesterId);
            RosterEvent.RosterCreated e;
            try {
                e = verifyCreate(eventFactory, rosterId, status, speed, updatedCoordinates, coordinatesUpdatedAt, targetCoordinates, originCoordinates, shipBattleId, c);
            } catch (Exception ex) {
        ...
        @Override
        public void createEnvironmentRoster(RosterId rosterId, Coordinates coordinates, Long shipResourceQuantity, Long shipBaseResourceQuantity, Long baseExperience, Long offChainVersion, String commandId, String requesterId, RosterCommands.CreateEnvironmentRoster c) {
            java.util.function.Supplier<RosterEvent.EnvironmentRosterCreated> eventFactory = () -> newEnvironmentRosterCreated(rosterId, coordinates, shipResourceQuantity, shipBaseResourceQuantity, baseExperience, offChainVersion, commandId, requesterId);
            RosterEvent.EnvironmentRosterCreated e;
            try {
                e = verifyCreateEnvironmentRoster(eventFactory, rosterId, coordinates, shipResourceQuantity, shipBaseResourceQuantity, baseExperience, c);
            } catch (Exception ex) {
                throw new DomainError("VerificationFailed", ex);
            }
        ...
        @Override
        public void setSail(String player, Coordinates targetCoordinates, BigInteger sailDuration, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId, RosterCommands.SetSail c) {
            java.util.function.Supplier<RosterEvent.RosterSetSail> eventFactory = () -> newRosterSetSail(player, targetCoordinates, sailDuration, updatedCoordinates, offChainVersion, commandId, requesterId);
            RosterEvent.RosterSetSail e;
            try {
                e = verifySetSail(eventFactory, player, targetCoordinates, sailDuration, updatedCoordinates, c);
            } catch (Exception ex) {
                throw new DomainError("VerificationFailed", ex);
            }
        ...
        @Override
        public void transferShip(String player, String shipId, String toRoster, BigInteger toPosition, Long offChainVersion, String commandId, String requesterId, RosterCommands.TransferShip c) {
        ...
        @Override
        public void takeOutShipInventory(String player, String shipId, ItemIdQuantityPairs itemIdQuantityPairs, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId, RosterCommands.TakeOutShipInventory c) {
            java.util.function.Supplier<RosterEvent.RosterShipInventoryTakenOut> eventFactory = () -> newRosterShipInventoryTakenOut(player, shipId, itemIdQuantityPairs, updatedCoordinates, offChainVersion, commandId, requesterId);
        ...
        @Override
        public void putInShipInventory(String player, String shipId, ItemIdQuantityPairs itemIdQuantityPairs, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId, RosterCommands.PutInShipInventory c) {
            java.util.function.Supplier<RosterEvent.RosterShipInventoryPutIn> eventFactory = () -> newRosterShipInventoryPutIn(player, shipId, itemIdQuantityPairs, updatedCoordinates, offChainVersion, commandId, requesterId);
        ...
        protected RosterEvent.RosterCreated verifyCreate(java.util.function.Supplier<RosterEvent.RosterCreated> eventFactory, RosterId rosterId, Integer status, Long speed, Coordinates updatedCoordinates, BigInteger coordinatesUpdatedAt, Coordinates targetCoordinates, Coordinates originCoordinates, String shipBattleId, RosterCommands.Create c) {
            ...
            RosterEvent.RosterCreated e = (RosterEvent.RosterCreated) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{eventFactory, getState(), rosterId, status, speed, updatedCoordinates, coordinatesUpdatedAt, targetCoordinates, originCoordinates, shipBattleId, VerificationContext.forCommand(c)}
            );

//package org.dddml.aptosinfiniteseas.domain.roster;
//
//public class CreateLogic {
//    public static RosterEvent.RosterCreated verify(java.util.function.Supplier<RosterEvent.RosterCreated> eventFactory, RosterState rosterState, RosterId rosterId, Integer status, Long speed, Coordinates updatedCoordinates, BigInteger coordinatesUpdatedAt, Coordinates targetCoordinates, Coordinates originCoordinates, String shipBattleId, VerificationContext verificationContext) {
//    }
//}
        ...
        protected RosterEvent.EnvironmentRosterCreated verifyCreateEnvironmentRoster(java.util.function.Supplier<RosterEvent.EnvironmentRosterCreated> eventFactory, RosterId rosterId, Coordinates coordinates, Long shipResourceQuantity, Long shipBaseResourceQuantity, Long baseExperience, RosterCommands.CreateEnvironmentRoster c) {
            RosterId RosterId = rosterId;
            ...
            RosterEvent.EnvironmentRosterCreated e = (RosterEvent.EnvironmentRosterCreated) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{eventFactory, getState(), rosterId, coordinates, shipResourceQuantity, shipBaseResourceQuantity, baseExperience, VerificationContext.forCommand(c)}
            );

//package org.dddml.aptosinfiniteseas.domain.roster;
//
//public class CreateEnvironmentRosterLogic {
//    public static RosterEvent.EnvironmentRosterCreated verify(java.util.function.Supplier<RosterEvent.EnvironmentRosterCreated> eventFactory, RosterState rosterState, RosterId rosterId, Coordinates coordinates, Long shipResourceQuantity, Long shipBaseResourceQuantity, Long baseExperience, VerificationContext verificationContext) {
//    }
//}
...
//}
        ...
        protected RosterEvent.RosterShipTransferred verifyTransferShip(java.util.function.Supplier<RosterEvent.RosterShipTransferred> eventFactory, String player, String shipId, String toRoster, BigInteger toPosition, RosterCommands.TransferShip c) {
            String Player = player;
...
//    public static RosterEvent.RosterShipTransferred verify(java.util.function.Supplier<RosterEvent.RosterShipTransferred> eventFactory, RosterState rosterState, String player, String shipId, String toRoster, BigInteger toPosition, VerificationContext verificationContext) {
//    }
//}
...
//}
        ...
        protected AbstractRosterEvent.RosterCreated newRosterCreated(RosterId rosterId, Integer status, Long speed, Coordinates updatedCoordinates, BigInteger coordinatesUpdatedAt, Coordinates targetCoordinates, Coordinates originCoordinates, String shipBattleId, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
            AbstractRosterEvent.RosterCreated e = new AbstractRosterEvent.RosterCreated();

            e.getDynamicProperties().put("rosterId", rosterId);
        ...
        protected AbstractRosterEvent.EnvironmentRosterCreated newEnvironmentRosterCreated(RosterId rosterId, Coordinates coordinates, Long shipResourceQuantity, Long shipBaseResourceQuantity, Long baseExperience, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
        ...
        protected AbstractRosterEvent.RosterSetSail newRosterSetSail(String player, Coordinates targetCoordinates, BigInteger sailDuration, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
            AbstractRosterEvent.RosterSetSail e = new AbstractRosterEvent.RosterSetSail();

            e.setPlayerId(null);
            e.getDynamicProperties().put("targetCoordinates", targetCoordinates);
            e.getDynamicProperties().put("sailDuration", sailDuration);
            e.setSetSailAt(null);
            e.getDynamicProperties().put("updatedCoordinates", updatedCoordinates);
        ...
        protected AbstractRosterEvent.RosterShipTransferred newRosterShipTransferred(String player, String shipId, String toRoster, BigInteger toPosition, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
            ...
            e.getDynamicProperties().put("toRoster", toRoster);
        ...
        protected AbstractRosterEvent.RosterShipInventoryTakenOut newRosterShipInventoryTakenOut(String player, String shipId, ItemIdQuantityPairs itemIdQuantityPairs, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
        ...
        protected AbstractRosterEvent.RosterShipInventoryPutIn newRosterShipInventoryPutIn(String player, String shipId, ItemIdQuantityPairs itemIdQuantityPairs, Coordinates updatedCoordinates, Long offChainVersion, String commandId, String requesterId) {
            RosterEventId eventId = new RosterEventId(getState().getId(), null);
