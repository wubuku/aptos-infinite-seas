...
import org.dddml.aptosinfiniteseas.domain.ship.ShipEvent.*;
...
public abstract class AbstractShipState implements ShipState.SqlShipState {
    ...
    public void when(AbstractShipEvent.ShipCreated e) {
        ...
        ShipState updatedShipState = (ShipState) ReflectUtils.invokeStaticMethod(
                    ...
                    new Object[]{this, owner, healthPoints, attack, protection, speed, buildingExpenses, aptosEventVersion, aptosEventSequenceNumber, aptosEventType, aptosEventGuid, eventStatus, MutationContext.forEvent(e, s -> {if (s == this) {return this;} else {throw new UnsupportedOperationException();}})}
            );

//package org.dddml.aptosinfiniteseas.domain.ship;
//
//public class CreateLogic {
//    public static ShipState mutate(ShipState shipState, String owner, Long healthPoints, Long attack, Long protection, Long speed, ItemIdQuantityPairs buildingExpenses, BigInteger aptosEventVersion, BigInteger aptosEventSequenceNumber, String aptosEventType, AptosEventGuid aptosEventGuid, String eventStatus, MutationContext<ShipState, ShipState.MutableShipState> mutationContext) {
//    }
//}
