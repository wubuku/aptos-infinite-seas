...
public interface ItemProductionStateQueryRepository {
    ...
    ItemProductionState getFirst(Iterable<Map.Entry<String, Object>> filter, List<String> orders);

    ItemProductionState getFirst(Map.Entry<String, Object> keyValue, List<String> orders);
